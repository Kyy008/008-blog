...
export const siteConfig: SiteConfig = {
	title: "008-Blog",
	subtitle: "Kyy008 的个人站点",
	siteURL: "https://blog.kyy008.me/", // 请替换为你的站点URL，以斜杠结尾
	...
	banner: {
		...
		src: {
			desktop: [
				"/assets/desktop-banner/1.webp?v=1",
				"/assets/desktop-banner/2.webp?v=1",
				"/assets/desktop-banner/3.webp?v=1",
				"/assets/desktop-banner/4.webp?v=1",
				"/assets/desktop-banner/5.webp?v=1",
			], // 桌面横幅图片
			mobile: [
...
export const pioConfig: import("./types/config").PioConfig = {
	enable: true, // 启用看板娘
	models: ["/pio/models/chino/香风智乃.model3.json"], // 默认模型路径
	position: "left", // 模型位置
...
export const umamiConfig = {
	...
	apiKey: import.meta.env.UMAMI_API_KEY || "api_l8nEg1wyXSgaTvJbhXs4nZnegY6QeusL", // API密钥优先从环境变量读取，否则使用配置文件中的值
	baseUrl: "https://api.umami.is", // Umami Cloud API地址
	scripts: `
<script defer src="https://cloud.umami.is/script.js" data-website-id="be7c8d4e-3ee9-45a9-9f26-347c5001f5e6"></script>
